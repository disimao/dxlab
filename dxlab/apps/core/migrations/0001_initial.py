    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_phone_number', models.IntegerField(unique=True, verbose_name='Mobile phone number')),
            ...
            options={
                'ordering': ['-id'],
                'unique_together': {('mobile_phone_number', 'email')},
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Customers', verbose_name='Customer')),
                ('items', models.ManyToManyField(blank=True, through='core.OrderItems', to='core.Products', verbose_name='Items')),
            ],
            options={
                'ordering': ['-created_at', '-updated_at'],
                'abstract': False,
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Orders', verbose_name='Order'),
        ),
        migrations.AddField(
            model_name='orderitems',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Products', verbose_name='Product'),
        ),
    ]
